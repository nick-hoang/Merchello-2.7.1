namespace Merchello.Core.Models.Rdbms
{
    ...
    /*SELECT A.*,
                 (SELECT SUBSTRING
                            ...
                            FROM merchProductVariant AS B
    
                            WHERE B.productKey = A.productKey FOR XML PATH('')), 2, 9999)) AS variantSkus
FROM[AaxisPacificWebsite].[dbo].[merchProductVariant]
    A
WHERE[master] = 1*/
    /// <summary>
    /// The product variant dto.
    /// </summary>
    [TableName("merchProductVariantAdvanceSearchView")]
    [PrimaryKey("pk", autoIncrement = false)]
    [ExplicitColumns]
    public class ProductVariantAdvanceSearchDto : IPageableDto, IDto
    {
        /// <summary>
        /// Gets or sets the key.
        /// </summary>
        ...
        /// <summary>
        /// combination of master sku and all variant skus
        /// </summary>
        [Column("variantSkus")]
        [NullSetting(NullSetting = NullSettings.Null)]
